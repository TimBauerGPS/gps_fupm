...
import { buildFupmJobUrl, mapHistoryRow, projectExistsForCompany, validateProjectName } from './_externalProject.js'
...
export const handler = async (event) => {
  ...
  try {
    ...
    return jsonResponse(200, {
      ...
      letters: (data || []).map(mapHistoryRow),
    })
  } catch (error) {
